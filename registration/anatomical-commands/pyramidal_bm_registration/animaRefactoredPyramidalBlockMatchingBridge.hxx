#pragma once
#include "animaRefactoredPyramidalBlockMatchingBridge.h"
...
RefactoredPyramidalBlockMatchingBridge<ImageDimension>::RefactoredPyramidalBlockMatchingBridge()
{
...
template <unsigned int ImageDimension>
void RefactoredPyramidalBlockMatchingBridge<ImageDimension>::Abort()
{
    m_Abort = true;
...
template <unsigned int ImageDimension>
void RefactoredPyramidalBlockMatchingBridge<ImageDimension>::SetInitialTransform (std::string initialTransformFile)
{
...
template <unsigned int ImageDimension>
void RefactoredPyramidalBlockMatchingBridge<ImageDimension>::Update()
{
...
template <unsigned int ImageDimension>
void RefactoredPyramidalBlockMatchingBridge<ImageDimension>::EmitProgress(int prog)
{
...
template <unsigned int ImageDimension>
void RefactoredPyramidalBlockMatchingBridge<ImageDimension>::ManageProgress (itk::Object* caller, const itk::EventObject& event, void* clientData)
{
    RefactoredPyramidalBlockMatchingBridge * source = reinterpret_cast<RefactoredPyramidalBlockMatchingBridge *> (clientData);
...
template <unsigned int ImageDimension>
        void RefactoredPyramidalBlockMatchingBridge<ImageDimension>::SetupPyramids()
{
