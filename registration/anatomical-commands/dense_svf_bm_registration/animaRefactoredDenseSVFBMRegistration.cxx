...
int main(int argc, const char** argv)
{
    ...
    typedef anima::RefactoredPyramidalDenseSVFMatchingBridge <Dimension> PyramidBMType;
    ...
    TCLAP::ValueArg<double> searchSkewRadiusArg("","skr","Search skew radius in degrees (rho start for bobyqa / newuoa, default: 5)",false,5,"optimizer search skew radius",cmd);
