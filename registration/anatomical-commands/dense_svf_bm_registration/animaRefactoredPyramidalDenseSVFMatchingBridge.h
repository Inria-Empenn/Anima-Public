...
class RefactoredPyramidalDenseSVFMatchingBridge : public itk::ProcessObject
{
public:
    ...
    typedef RefactoredPyramidalDenseSVFMatchingBridge Self;
    ...
    itkTypeMacro(RefactoredPyramidalDenseSVFMatchingBridge,itk::ProcessObject);
...
protected:
    RefactoredPyramidalDenseSVFMatchingBridge();
    virtual ~RefactoredPyramidalDenseSVFMatchingBridge();
...
#include "animaRefactoredPyramidalDenseSVFMatchingBridge.hxx"
