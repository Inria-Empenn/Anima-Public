#pragma once
#include "animaRefactoredPyramidalDenseSVFMatchingBridge.h"
...
#include <animaRefactoredKissingSymmetricBMRegistrationMethod.h>
...
RefactoredPyramidalDenseSVFMatchingBridge<ImageDimension>::RefactoredPyramidalDenseSVFMatchingBridge()
{
...
template <unsigned int ImageDimension>
void
RefactoredPyramidalDenseSVFMatchingBridge<ImageDimension>::Abort()
{
    m_Abort = true;
...
template <unsigned int ImageDimension>
void
RefactoredPyramidalDenseSVFMatchingBridge<ImageDimension>::Update()
{
    m_Abort = false;
    ...
    for (unsigned int i = 0;i < m_ReferencePyramid->GetNumberOfLevels();++i)
    {
        ...
        switch (m_SymmetryType)
        {
            case Asymmetric:
            {
                typedef typename anima::RefactoredAsymmetricBMRegistrationMethod <InputImageType> BlockMatchRegistrationType;
            ...
            case Symmetric:
            {
                typedef typename anima::RefactoredSymmetricBMRegistrationMethod <InputImageType> BlockMatchRegistrationType;
            ...
            case Kissing:
            {
                typedef typename anima::RefactoredKissingSymmetricBMRegistrationMethod <InputImageType> BlockMatchRegistrationType;
                m_bmreg = BlockMatchRegistrationType::New();
                break;
            }
        }
...
template <unsigned int ImageDimension>
typename RefactoredPyramidalDenseSVFMatchingBridge<ImageDimension>::DisplacementFieldTransformPointer
RefactoredPyramidalDenseSVFMatchingBridge<ImageDimension>::GetOutputDisplacementFieldTransform()
{
    DisplacementFieldTransformPointer outputDispTrsf = DisplacementFieldTransformType::New();
...
template <unsigned int ImageDimension>
void
RefactoredPyramidalDenseSVFMatchingBridge<ImageDimension>::EmitProgress(int prog)
{
...
template <unsigned int ImageDimension>
void RefactoredPyramidalDenseSVFMatchingBridge<ImageDimension>::ManageProgress (itk::Object* caller, const itk::EventObject& event, void* clientData)
{
    RefactoredPyramidalDenseSVFMatchingBridge * source = reinterpret_cast<RefactoredPyramidalDenseSVFMatchingBridge *> (clientData);
...
template <unsigned int ImageDimension>
void
RefactoredPyramidalDenseSVFMatchingBridge<ImageDimension>::WriteOutputs()
{
...
template <unsigned int ImageDimension>
void
RefactoredPyramidalDenseSVFMatchingBridge<ImageDimension>::SetupPyramids()
{
