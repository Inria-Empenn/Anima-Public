#pragma once
#include "animaRefactoredPyramidalDenseTensorSVFMatchingBridge.h"
...
RefactoredPyramidalDenseTensorSVFMatchingBridge<ImageDimension>::RefactoredPyramidalDenseTensorSVFMatchingBridge()
{
...
template <unsigned int ImageDimension>
void
RefactoredPyramidalDenseTensorSVFMatchingBridge<ImageDimension>::Update()
{
    this->SetupPyramids();
...
template <unsigned int ImageDimension>
void
RefactoredPyramidalDenseTensorSVFMatchingBridge<ImageDimension>::WriteOutputs()
{
...
template <unsigned int ImageDimension>
void
RefactoredPyramidalDenseTensorSVFMatchingBridge<ImageDimension>::SetupPyramids()
{
