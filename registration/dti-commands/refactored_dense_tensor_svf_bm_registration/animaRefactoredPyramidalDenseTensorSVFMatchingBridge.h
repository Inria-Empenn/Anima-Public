...
class RefactoredPyramidalDenseTensorSVFMatchingBridge : public itk::ProcessObject
{
public:
    ...
    typedef RefactoredPyramidalDenseTensorSVFMatchingBridge Self;
    ...
    itkTypeMacro(RefactoredPyramidalDenseTensorSVFMatchingBridge,itk::ProcessObject);
...
protected:
    RefactoredPyramidalDenseTensorSVFMatchingBridge();
    virtual ~RefactoredPyramidalDenseTensorSVFMatchingBridge();
...
#include "animaRefactoredPyramidalDenseTensorSVFMatchingBridge.hxx"
