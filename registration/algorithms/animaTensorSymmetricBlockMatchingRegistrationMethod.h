...
namespace anima
{
    ...
    class TensorSymmetricBlockMatchingRegistrationMethod : public TensorBlockMatchingBaseRegistrationMethod <TInputImage>
    {
    public:
        /** Standard class typedefs. */
        typedef TensorSymmetricBlockMatchingRegistrationMethod Self;
        ...
        itkTypeMacro(TensorSymmetricBlockMatchingRegistrationMethod, BlockMatchingBaseRegistrationMethod);
    ...
    protected:
        ...
        virtual ~TensorSymmetricBlockMatchingRegistrationMethod() {}
        
        virtual void PerformOneIteration(InputImageType *refImage, InputImageType *movingImage, TransformPointer &addOn);
        
    private:
        TensorSymmetricBlockMatchingRegistrationMethod(const Self&); //purposely not implemented
...
#include "animaTensorSymmetricBlockMatchingRegistrationMethod.hxx"
