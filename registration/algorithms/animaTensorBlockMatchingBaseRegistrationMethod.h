...
class TensorBlockMatchingBaseRegistrationMethod : public itk::ProcessObject
{
public:
    /** Standard class typedefs. */
    typedef TensorBlockMatchingBaseRegistrationMethod  Self;
    ...
    enum SimilarityDefinition {TensorMeanSquares, TensorCorrelation, TensorGeneralizedCorrelation, TensorOrientedGeneralizedCorrelation};

    /** Run-time type information (and related methods). */
    itkTypeMacro(TensorBlockMatchingBaseRegistrationMethod, itk::ProcessObject);
    ...
    /**  Type of the metric. */
    typedef anima::BaseTensorImageToImageMetric<InputImageType, InputImageType> MetricType;
    ...
    itkSetMacro (BlockTensorVarianceThreshold, double);
    itkGetMacro (BlockTensorVarianceThreshold, double);
...
protected:
    ...
    virtual ~TensorBlockMatchingBaseRegistrationMethod() {}
...
private:
    TensorBlockMatchingBaseRegistrationMethod(const Self&); //purposely not implemented
    ...
    double m_BlockTensorVarianceThreshold;
...
#include "animaTensorBlockMatchingBaseRegistrationMethod.hxx"
