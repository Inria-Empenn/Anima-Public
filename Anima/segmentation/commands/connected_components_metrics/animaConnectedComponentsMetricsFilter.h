...
public:
    ...
    typedef anima::ConnectedComponentsVolumeFilter<ImageType> ConnectedComponentVolumeFilterType;
    ...
    std::vector<unsigned short int> GetTestTP(){return m_vect_true_positive_test;}
    std::vector<unsigned short int> GetRefTP(){return m_vect_true_positive_ref;}
...
private:
    ...
    std::vector<unsigned short int> m_vect_false_positive_test;             /*!< List of false positive objects in test image */
