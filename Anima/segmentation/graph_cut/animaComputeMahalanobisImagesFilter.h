...
public:
  ...
  using Self = ComputeMahalanobisImagesFilter;
  using Superclass = itk::ImageToImageFilter<TInputImage, TOutput>;
  ...
  using ImageConstIteratorTypeUC = itk::ImageRegionConstIterator<ImageTypeUC>;
