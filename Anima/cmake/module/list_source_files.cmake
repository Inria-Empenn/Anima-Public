...
macro(list_source_files_recurse
  project_name
  directories
  )
...
macro(list_include_dirs project_name)
  
foreach(header ${${project_name}_HEADERS})
  cmake_path(GET header PARENT_PATH header_path)
  list(APPEND ${project_name}_INCLUDE_PATHS ${header_path})
endforeach()

foreach(header ${${project_name}_TEMPLATES})
  cmake_path(GET header PARENT_PATH header_path)
  list(APPEND ${project_name}_INCLUDE_PATHS ${header_path})
endforeach()


list(REMOVE_DUPLICATES ${project_name}_INCLUDE_PATHS)
