...
# PAIRING_DIR: Path to the directory containing pairing_txt_*.cmake files.

# Remove existing mapping files if they exist.
if(EXISTS ${NEW_TO_OLD_PATH}/newToOld.txt)
  file(REMOVE ${NEW_TO_OLD_PATH}/newToOld.txt)
endif()
if(EXISTS ${OLD_TO_NEW_PATH}/oldToNew.txt)
  file(REMOVE ${OLD_TO_NEW_PATH}/oldToNew.txt)
endif()
...
foreach(exe_name ${exe_names})
  # Include the corresponding pairing_txt_*.cmake file if it exists.
  if(EXISTS "${PAIRING_DIR}/pairing_txt_${exe_name}.cmake")
    include("${PAIRING_DIR}/pairing_txt_${exe_name}.cmake")
  endif()
endforeach()