...
set(${PROJECT_NAME}_INCLUDE_DIRS 
  ...
  "${TCLAP_INCLUDE_DIR}"
  "${NLOPT_INCLUDE_DIR}"
  "${NLOPT_SECONDARY_INCLUDE_DIR}"
  "${TinyXML2_INCLUDE_DIR}"
)

if (BUILD_MODULE_MATHS)
  list(APPEND ${PROJECT_NAME}_HEADER_PATHS ${${PROJECT_NAME}_SOURCE_DIR}/math-tools ${${PROJECT_NAME}_BINARY_DIR}/math-tools)
endif()

if (BUILD_MODULE_FILTERING)
  list(APPEND ${PROJECT_NAME}_HEADER_PATHS ${${PROJECT_NAME}_SOURCE_DIR}/filtering ${${PROJECT_NAME}_BINARY_DIR}/filtering)
endif()

if (BUILD_MODULE_DIFFUSION)
  list(APPEND ${PROJECT_NAME}_HEADER_PATHS ${${PROJECT_NAME}_SOURCE_DIR}/diffusion ${${PROJECT_NAME}_BINARY_DIR}/diffusion)
endif()

if (BUILD_MODULE_REGISTRATION)
  list(APPEND ${PROJECT_NAME}_HEADER_PATHS ${${PROJECT_NAME}_SOURCE_DIR}/registration ${${PROJECT_NAME}_BINARY_DIR}/registration)
endif()

if (BUILD_MODULE_QUANTITATIVE_MRI)
  list(APPEND ${PROJECT_NAME}_HEADER_PATHS ${${PROJECT_NAME}_SOURCE_DIR}/quantitative-mri ${${PROJECT_NAME}_BINARY_DIR}/quantitative-mri)
endif()

if (BUILD_MODULE_SEGMENTATION)
  list(APPEND ${PROJECT_NAME}_HEADER_PATHS ${${PROJECT_NAME}_SOURCE_DIR}/segmentation ${${PROJECT_NAME}_BINARY_DIR}/segmentation)
endif()
