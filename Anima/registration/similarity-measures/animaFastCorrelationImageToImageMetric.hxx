...
FastCorrelationImageToImageMetric<
    TFixedImage, TMovingImage>::FastCorrelationImageToImageMetric() {
  m_SumFixed = 0;
  m_VarFixed = 0;
...
template <class TFixedImage, class TMovingImage>
typename FastCorrelationImageToImageMetric<TFixedImage,
                                           TMovingImage>::MeasureType
FastCorrelationImageToImageMetric<TFixedImage, TMovingImage>::GetValue(
  ...
  typedef
      typename itk::NumericTraits<MeasureType>::AccumulateType AccumulateType;
...
template <class TFixedImage, class TMovingImage>
void FastCorrelationImageToImageMetric<TFixedImage,
  ...
  m_VarFixed =
      sumSquared - m_SumFixed * m_SumFixed / this->m_NumberOfPixelsCounted;
}

template <class TFixedImage, class TMovingImage>
void FastCorrelationImageToImageMetric<TFixedImage, TMovingImage>::
...
template <class TFixedImage, class TMovingImage>
void FastCorrelationImageToImageMetric<TFixedImage, TMovingImage>::PrintSelf(
