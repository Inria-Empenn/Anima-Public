...
DenseSVFTransformAgregator<NDimensions>::DenseSVFTransformAgregator()
    : Superclass() {
...
template <unsigned int NDimensions>
bool DenseSVFTransformAgregator<NDimensions>::Update() {
...
template <unsigned int NDimensions>
void DenseSVFTransformAgregator<NDimensions>::estimateSVFFromTranslations() {
  ...
  for (unsigned int i = 0; i < nbPts; ++i) {
    ...
    bool isInside = weights->TransformPhysicalPointToIndex(
        this->GetInputOrigin(i), posIndex);
    for (unsigned int j = 0; j < NDimensions; ++j)
  ...
  typedef anima::MEstimateSVFImageFilter<ScalarType, NDegreesFreedom,
                                         NDimensions>
      SVFMEstimateType;
...
template <unsigned int NDimensions>
void DenseSVFTransformAgregator<NDimensions>::estimateSVFFromRigidTransforms() {
...
template <unsigned int NDimensions>
void DenseSVFTransformAgregator<
