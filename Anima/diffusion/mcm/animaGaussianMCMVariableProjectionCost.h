...
/**
 * @brief Class for computing variable projection costs and derivatives. Right
 * now, it is only available for Gaussian noise. By the way, this is not thread
 * safe at all so be sure to intantiate one per thread
 */
class ANIMAMCM_EXPORT GaussianMCMVariableProjectionCost
    : public anima::BaseMCMCost {
public:
