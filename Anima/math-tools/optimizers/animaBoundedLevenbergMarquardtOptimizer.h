 ...
 * @brief Levenberg-Marquardt optimizer with lower and upper bounds on
 * parameters Implementation of the original algorithmm, very well described in
 * K. Madsen, H.B. Nielsen and O. Tingleff. Methods for non-linear least squares
 * problems. 2004
 * http://www2.imm.dtu.dk/pubdb/views/edoc_download.php/3215/pdf/imm3215.pdf
 * Bounded version by projection as suggested by Kanzow et al. but with a lot of
 * modifications, including calculation of optimal lambda C. Kanzow, N.
 * Yamashita and M. Fukushima. Levenberg-Marquardt methods with strong local
 * convergence properties for solving nonlinear equations with convex
 * constraints. Journal of computational and applied mathematics. 172:375-397,
 * 2004.
 */
...
public:
  ...
  using Self = BoundedLevenbergMarquardtOptimizer;
  using Superclass = itk::MultipleValuedNonLinearOptimizer;
  ...
  itkTypeMacro(BoundedLevenbergMarquardtOptimizer,
...
protected:
  ...
  double EvaluateCostFunctionAtParameters(ParametersType &parameters,
                                          MeasureType &residualValues);

  bool CheckSolutionIsInBounds(ParametersType &solutionVector,
  ...
  bool CheckConditions(unsigned int numIterations, ParametersType &newParams,
                       ParametersType &oldParams, ParametersType &dValues,
                       double newCostValue);
