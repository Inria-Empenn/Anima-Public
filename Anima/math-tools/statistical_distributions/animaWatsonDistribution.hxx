    ...
    void GetStandardWatsonSHCoefficients(const ScalarType k, std::vector<ScalarType> &coefficients, std::vector<ScalarType> &derivatives)
{
    ...
    // checked
    derivatives[1] = sqrtPi * (60.0 * kSqrt + 15.0 * (-21.0 + 2.0 * k) / kSqrt + 30.0 * kSqrt * (-21.0 + 2.0 * k) + 9.0 * (35.0 + 20.0 * k + 4.0 * k2) / kSqrt + 9.0 * (20.0 + 8.0 * k) * 2.0 * dawsonValue) / (16.0 * k2 * 2.0 * dawsonValue) - sqrtPi * (30.0 * kSqrt * (-21.0 + 2.0 * k) + 9.0 * (35.0 + 20.0 * k + 4.0 * k2) * 2.0 * dawsonValue) / (16.0 * k2 * kSqrt * 4.0 * dawsonValue * dawsonValue) - sqrtPi * (30.0 * kSqrt * (-21.0 + 2.0 * k) + 9.0 * (35.0 + 20.0 * k + 4.0 * k2) * 2.0 * dawsonValue) / (8.0 * k3 * 2.0 * dawsonValue);
    
    // checked
    derivatives[2] = std::sqrt(17.0) * sqrtPi * (6.0 * kSqrt * (30030.0 - 15400.0 * k + 744.0 * k2) + (3.0 * (-225225.0 + 30030.0 * k - 7700.0 * k2 + 248.0 * k3)) / kSqrt + 6.0 * kSqrt * (-225225.0 + 30030.0 * k - 7700.0 * k2 + 248.0 * k3) + 35.0 * (19305.0 + 10296.0 * k + 2376.0 * k2 + 288.0 * k3 + 16.0 * k4) / kSqrt + 35.0 * (10296.0 + 4752.0 * k + 864.0 * k2 + 64.0 * k3) * 2.0 * dawsonValue) / (1024.0 * k4 * 2.0 * dawsonValue) - std::sqrt(17.0) * sqrtPi * (6.0 * kSqrt * (-225225.0 + 30030.0 * k - 7700.0 * k2 + 248.0 * k3) + 35.0 * (19305.0 + 10296.0 * k + 2376.0 * k2 + 288.0 * k3 + 16.0 * k4) * 2.0 * dawsonValue) / (1024.0 * k4 * kSqrt * 4.0 * dawsonValue * dawsonValue) - std::sqrt(17.0) * sqrtPi * (6.0 * kSqrt * (-225225.0 + 30030.0 * k - 7700.0 * k2 + 248.0 * k3) + 35.0 * (19305.0 + 10296.0 * k + 2376.0 * k2 + 288.0 * k3 + 16.0 * k4) * 2.0 * dawsonValue) / (256.0 * k5 * 2.0 * dawsonValue);
