...
GetRotationMatrixFromVectors(const VectorType &first_direction,
  ...
  VectorType tmpVec;
  tmpVec[0] = first_direction[1] * second_direction[2] -
              first_direction[2] * second_direction[1];
  tmpVec[1] = first_direction[2] * second_direction[0] -
              first_direction[0] * second_direction[2];
  tmpVec[2] = first_direction[0] * second_direction[1] -
