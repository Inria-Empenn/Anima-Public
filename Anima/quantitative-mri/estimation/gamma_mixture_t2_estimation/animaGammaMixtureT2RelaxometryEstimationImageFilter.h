...
public:
  ...
  using Self = GammaMixtureT2RelaxometryEstimationImageFilter;
  ...
  itkTypeMacro(GammaMixtureT2RelaxometryEstimationImageFilter,
...
protected:
  GammaMixtureT2RelaxometryEstimationImageFilter() : Superclass() {
