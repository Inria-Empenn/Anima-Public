...
public:
  ...
  using Self = B1GammaMixtureT2RelaxometryCostFunction;
  ...
  itkTypeMacro(B1GammaMixtureT2RelaxometryCostFunction,
  ...
  /**
   * The measure type shall be used for computing the cost function value to
   * observe convergence Parameters are set as
   * {flip_angle,theta_1,theta_2,theta_3} for unconstrained estimation Or
   * {flip_angle,theta_2} for constrained
   */
  virtual MeasureType
