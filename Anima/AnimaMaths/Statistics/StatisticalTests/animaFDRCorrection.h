...
namespace anima
{
     ...
     */
    LIBANIMAMATHS_EXPORT void BHCorrection(std::vector <double> &pvalues, double qValue);
    LIBANIMAMATHS_EXPORT void BYCorrection(std::vector <double> &pvalues, double qValue);
